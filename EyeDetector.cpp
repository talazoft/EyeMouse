...
int main(int argc, char **argv)
{
  ...
  if (!faceCascade.load("./opencv/data/haarcascades/haarcascade_frontalface_alt.xml"))
  {
      std::cerr << "Could not load face detector." << std::endl;
      return -1;
  }    
  if (!eyeCascade.load("./opencv/data/haarcascades/haarcascade_eye_tree_eyeglasses.xml"))
  {
